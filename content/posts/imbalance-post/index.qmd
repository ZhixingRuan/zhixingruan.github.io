...
The standards can be simplified as: assume the average profit brought by a good applicant as 'gain_avg', and the average financial loss caused by a bad applicant as 'loss_avg'. The number of good applicants as 'n_class0', and the number of bad applicants as 'n_class1'.

The business value of a model can be represented as:
$$TN * gain\_avg - FN * loss\_avg$$

**Model selection should be based on comparing this business values of different models.**
